                  ...
                  ListTile(
                    onTap: (){
                      ...
                      Navigator.push(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (c, a1, a2) =>  View_notification_page(id: notifications?[index].id,),
                    ...
                    leading: Column(
                      ...
                      children:  [
                        JooseText(
                          text: "${notifications?[index].title??""}",fontColor: Colors.black,
                          fontSize: 13,
                        ...
                        JooseText(
                          text: "${notifications?[index].description??""}",fontColor: Colors.black,
                          fontSize: 8,
                        ),
                    ...
                    trailing: JooseText(
                      text: "${notifications?[index].time??""}",fontColor: Colors.red,
                      fontSize: 10,
  ...
  Widget notiEmpty(){
    return Column(
      children:  [
        ...
        Center(
          child: JooseText(text: AppLocalizations.of(context).translate("No Notifiation found Here" ),fontColor: Colors.black, fontWeight: FontWeight.w600, fontSize: 20,),
        ),
      ],
    );
  }
